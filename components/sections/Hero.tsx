...
export function Hero() {
  return (
    <section
      className="relative min-h-screen flex flex-col justify-start sm:justify-center pt-16 overflow-hidden bg-graphite"
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-10 max-w-6xl mx-auto px-5 sm:px-8 pt-1 pb-6 sm:py-16">
