  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-5 sm:px-8">
        ...
        >
          {t.whatWeDo.heading1}{' '}
          <span style={{ color: '#E8870C' }}>{t.whatWeDo.heading2}</span>
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div data-reveal data-reveal-delay="60" className="relative bg-surface rounded-2xl p-8 border border-white/6 overflow-hidden group hover:border-amber/20 transition-colors duration-300">
            ...
            <h3 className="text-[22px] font-bold text-white mb-3" style={{ fontFamily: 'var(--font-barlow), sans-serif', letterSpacing: '-0.02em' }}>
              {t.whatWeDo.card1title}
            </h3>
            <p className="text-[14px] text-white/55 leading-[1.7]" style={{ fontFamily: 'var(--font-figtree), sans-serif' }}>
              {t.whatWeDo.card1text}
            </p>
          </div>
          ...
          <div data-reveal data-reveal-delay="120" className="relative bg-surface rounded-2xl p-8 border border-white/6 overflow-hidden group hover:border-amber/20 transition-colors duration-300">
            ...
            <h3 className="text-[22px] font-bold text-white mb-3" style={{ fontFamily: 'var(--font-barlow), sans-serif', letterSpacing: '-0.02em' }}>
              {t.whatWeDo.card2title}
            </h3>
            <p className="text-[14px] text-white/55 leading-[1.7]" style={{ fontFamily: 'var(--font-figtree), sans-serif' }}>
              {t.whatWeDo.card2text}
            </p>
          </div>
        </div>
      </div>
