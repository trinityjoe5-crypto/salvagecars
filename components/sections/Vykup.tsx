...
export function Vykup() {
  ...
  return (
    <section className="relative bg-graphite py-20 sm:py-28 overflow-hidden" aria-labelledby="vykup-heading">
      <div className="absolute -left-40 top-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full opacity-[0.07] blur-[100px] pointer-events-none" aria-hidden="true" style={{ background: '#E8870C' }} />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-5 sm:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div data-reveal>
            ...
            <h2 id="vykup-heading" className="mb-6" style={{ fontFamily: 'var(--font-barlow), sans-serif', fontWeight: 800, fontSize: 'clamp(2.2rem, 5vw, 3.5rem)', letterSpacing: '-0.03em', color: '#ffffff', lineHeight: 1.0 }}>
              {t.vykup.titleLine1}
              <br />
              {t.vykup.titleLine2}{' '}
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a
                ...
                className="
                  ...
                  text-white font-semibold rounded-xl border border-white/15
